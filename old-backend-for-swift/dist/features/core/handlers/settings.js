 ...
 */
export const getCallEligibility = async (c) => {
 ...
 */
export const getScheduleSettings = async (c) => {
    const userId = getAuthenticatedUserId(c);
    const env = c.env;
    const supabase = createSupabaseClient(env);
    try {
 ...
 */
export const updateSubscriptionStatus = async (c) => {
    const userId = getAuthenticatedUserId(c);
    ...
    try {
        ...
        if (revenuecatCustomerId) {
            ...
            console.log(`💰 Updating RevenueCat customer ID for user ${userId}: ${revenuecatCustomerId}`);
        }
 ...
 */
export const updateScheduleSettings = async (c) => {
    const userId = getAuthenticatedUserId(c);
 ...
 */
export const updateRevenueCatCustomerId = async (c) => {
    const userId = getAuthenticatedUserId(c);
    ...
    try {
        ...
        console.log(`✅ Updated RevenueCat customer ID for user ${userId}: ${originalAppUserId}`);
        return c.json({
            success: true,
            data,
