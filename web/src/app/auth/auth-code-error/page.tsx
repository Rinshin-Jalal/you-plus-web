  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0D0D0D] text-white px-6 relative">
      ...
      <div className="max-w-md space-y-4 text-center relative z-10">
        ...
        {details && (
          <div className="text-left text-xs bg-red-500/10 text-red-400 p-3 space-y-1 font-mono border border-red-500/30">
        ...
        <div className="text-left text-sm bg-white/5 text-white/80 p-4 space-y-2 border border-white/10">
        ...
        <div className="flex flex-col gap-2">
          <Link
            href="/auth/login"
            className="inline-flex justify-center px-4 py-3 text-sm font-bold uppercase tracking-wide bg-[#F97316] text-black hover:bg-[#FB923C] transition-colors"
          >
            Back to login
          </Link>
          <Link
            href="/auth/signup"
            className="inline-flex justify-center border border-white/20 px-4 py-3 text-sm font-medium text-white hover:bg-white/5 transition-colors"
          >
            Sign up instead
          </Link>
        </div>
