      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3 text-white">2.2 Onboarding & Goal Information</h3>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3 text-white">2.3 Voice Recordings</h3>
            <p className="text-white/70 mb-2">We collect voice recordings in two contexts:</p>
            <ul className="list-disc pl-6 text-white/70 space-y-2">
              <li><strong className="text-white">Onboarding recordings:</strong> Used to understand your motivation and to create a personalized AI voice for your accountability calls</li>
              <li><strong className="text-white">Call recordings:</strong> Daily accountability calls are recorded to track your progress and commitments</li>
            </ul>
            <div className="mt-4 p-4 bg-white/5 border-l-4 border-[#F97316]">
              <strong className="text-white">Important:</strong> Your voice recordings are NEVER used to train AI models. They are used solely for transcription and creating your personalized accountability experience.
            </div>

            <h3 className="text-lg font-bold mt-6 mb-3 text-white">2.4 Usage & Call Data</h3>
            <ul className="list-disc pl-6 text-white/70 space-y-2">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3 text-white">2.5 Payment Information</h3>
          ...
          <section>
            ...
            <p className="text-white/70 mb-4">We use the following third-party services to operate You+:</p>
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-white/70 border border-white/20">
                <thead className="bg-white/10">
                  <tr>
                    <th className="py-2 px-4 text-left font-bold uppercase text-white">Service</th>
                    <th className="py-2 px-4 text-left font-bold uppercase text-white">Purpose</th>
                    <th className="py-2 px-4 text-left font-bold uppercase text-white">Data Shared</th>
                  </tr>
                </thead>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-white/70 space-y-2">
              <li><strong className="text-white">Active accounts:</strong> We retain your data for as long as your account is active</li>
              <li><strong className="text-white">Call recordings & transcripts:</strong> Retained until you delete your account</li>
              <li><strong className="text-white">After account deletion:</strong> All data is permanently deleted within 14 days</li>
              <li><strong className="text-white">Payment records:</strong> May be retained longer as required by law for tax/accounting purposes</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-white/70 space-y-2">
              ...
              <li><strong className="text-white">Deletion:</strong> Delete your account and all associated data (Settings → Delete Account)</li>
            ...
            <p className="text-white/70 mt-4">
              To exercise these rights, contact us at <a href="mailto:privacy@youplus.app" className="underline text-[#F97316]">privacy@youplus.app</a>
            </p>

            <h3 className="text-lg font-bold mt-6 mb-3 text-white">For EU/EEA Residents (GDPR)</h3>
            <p className="text-white/70">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3 text-white">For California Residents (CCPA)</h3>
            <p className="text-white/70">
          ...
          <section>
            ...
            <p className="text-white/70 mb-4">We implement appropriate security measures to protect your data:</p>
            <ul className="list-disc pl-6 text-white/70 space-y-2">
          ...
          <section>
            ...
            <div className="p-4 border border-white/20 bg-white/5">
              ...
              <p className="text-white/70">
                Email: <a href="mailto:privacy@youplus.app" className="underline text-[#F97316]">privacy@youplus.app</a>
              </p>
            </div>
          </section>
        </div>
