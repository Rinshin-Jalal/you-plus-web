      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="space-y-10">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              You must be at least <strong>18 years old</strong> to use You+. By using the Service, you represent and warrant that you are 18 or older and have the legal capacity to enter into these Terms.
            </p>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">By using You+, you expressly consent to:</p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li><strong>Onboarding voice recordings:</strong> We record your voice during onboarding to understand your motivation and to create a personalized AI voice clone</li>
              <li><strong>Call recordings:</strong> All accountability calls are recorded for transcription and progress tracking</li>
              <li><strong>AI voice cloning:</strong> Your voice recordings are used to create a personalized AI voice for your accountability calls</li>
            </ul>
          ...
          <section>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">6.1 Subscription Plans</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">6.2 Automatic Renewal</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">6.3 Cancellation</h3>
            <p className="text-gray-700 leading-relaxed">You may cancel your subscription at any time through your account settings. Upon cancellation:</p>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">6.4 Refund Policy</h3>
            <p className="text-gray-700 mb-4 leading-relaxed">
              <strong>All subscription payments are non-refundable.</strong> We do not provide refunds or credits for:
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
            ...
            <p className="text-gray-700 mt-4 leading-relaxed">
              <strong>Refund Appeals:</strong> In exceptional circumstances, you may request a refund review by contacting <a href="mailto:support@youplus.app" className="underline font-bold">support@youplus.app</a>. All appeal decisions are final and made at our sole discretion.
            </p>

            <h3 className="text-lg font-bold mt-6 mb-3">6.5 Payment Processing</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <div className="p-4 bg-yellow-50 border-4 border-yellow-400 mb-4">
              <h3 className="text-lg font-bold mb-2 uppercase">Not Medical or Therapeutic Advice</h3>
              <p className="text-gray-700">
                You+ is a <strong>productivity and accountability tool</strong>. It is NOT a substitute for professional medical advice, diagnosis, treatment, therapy, or counseling. If you are experiencing mental health issues, please consult a qualified healthcare professional.
              </p>
            </div>
          ...
          <section>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">9.1 Our Content</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">9.2 Your Content</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">11.1 By You</h3>
            <p className="text-gray-700 leading-relaxed">
            ...
            <h3 className="text-lg font-bold mt-6 mb-3">11.2 By Us</h3>
            <p className="text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed uppercase font-bold">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>First attempted to be resolved through informal negotiation by contacting <a href="mailto:support@youplus.app" className="underline font-bold">support@youplus.app</a></li>
          ...
          <section>
            ...
            <div className="p-4 border-2 border-black">
              ...
              <p className="text-gray-700">
                Email: <a href="mailto:support@youplus.app" className="underline font-bold">support@youplus.app</a>
              </p>
            </div>
          </section>
        </div>
